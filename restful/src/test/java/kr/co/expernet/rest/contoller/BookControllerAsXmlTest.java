...
public class BookControllerAsXmlTest {
	...
	public void initMockMvc() {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(bookController).addFilters(filter).build();
	}
	...
	public void testGetBooks() throws Exception {
		...
		this.mockMvc.perform(requestBuilder).andDo(print())
				...
				.andExpect(xpath("/books/book").nodeCount(3)).andExpect(xpath("/books/book[1]/id").string("1"))
	...
	public void testCreateBook() throws Exception {
		String content = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" 
				+ "<book>" 
					+ "<id>100</id>"
					+ "<title>바라야 내전</title>"
					+ "<creator>로이스 맥마스터 부졸드</creator>"
					+ "<type>외국판타지소설</type>"
					+ "<date>2011-08-15T12:21:00+09:00</date>"
				+ "</book>";
