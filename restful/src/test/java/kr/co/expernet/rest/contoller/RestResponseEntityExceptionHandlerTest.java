...
public class RestResponseEntityExceptionHandlerTest {
	...
	public void initMockMvc() {
		...
		mockMvc = MockMvcBuilders.webAppContextSetup(webAppContext).addFilter(filter).build();
	}

	@Test
	public void testResourceNotFoundExceptionAsJson() throws Exception {
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/books/99")
	...
	public void testResourceNotFoundExceptionAsXml() throws Exception {
		...
		this.mockMvc.perform(requestBuilder).andDo(print())
				...
				.andExpect(xpath("/error/message").string("해당 자원을 찾을 수없습니다."));
	}
